...
const ICONS = {
  ...
  // Восходящий тренд / средний балл
  trendingUp:
    '<polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" />',

  // Буфер обмена / список документов
  clipboard:
  ...
  // Абитуриент (шапка-конфедератка)
  graduationCap:
    '<path d="M22 10v6M2 10l10-5 10 5-10 5z" /><path d="M6 12v5c3 3 9 3 12 0v-5" />',

  // Преподаватель (портфель/работа)
  briefcase:
    '<rect x="2" y="7" width="20" height="14" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" />',

  // Перемена (кружка кофе)
  coffee:
    '<path d="M18 8h1a4 4 0 0 1 0 8h-1" /><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z" /><line x1="6" y1="2" x2="6" y2="4" /><line x1="10" y1="2" x2="10" y2="4" /><line x1="14" y1="2" x2="14" y2="4" />',
