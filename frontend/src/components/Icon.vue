...
const ICONS = {
  ...
  settings:
    '<circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9c.66.27 1.1 1.93 1.1 1.65V12a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />',

  // Луна (тёмная тема)
  moon:
    '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />',

  // Колокольчик выключенный
  bellOff:
    '<path d="M13.73 21a2 2 0 0 1-3.46 0" /><path d="M18 8a6 6 0 0 0-9.33-5" /><path d="M8.5 12a5.5 5.5 0 0 1 6.5-5" /><path d="M19 16a8 8 0 0 1-1.32-3.41 8 8 0 0 1-.36-3.59" /><path d="M2 2l20 20" />',

  // Калькулятор
  calculator:
    '<rect x="4" y="2" width="16" height="20" rx="2" /><line x1="8" y1="6" x2="16" y2="6" /><line x1="16" y1="14" x2="16" y2="18" /><line x1="12" y1="14" x2="12" y2="14" /><line x1="8" y1="14" x2="8" y2="14" /><line x1="12" y1="18" x2="12" y2="18" /><line x1="8" y1="18" x2="8" y2="18" />',

  // Языки
  languages:
    '<path d="M5 8h14M9 4v4M5 12c0 4 3 7 7 7M19 18c-4 0-7-3-7-7M13 4l4 12M19 16h-6" />',
